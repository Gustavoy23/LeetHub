<h2>2432. The Employee That Worked on the Longest Task</h2><h3>Easy</h3><hr><div><p>There are <code>n</code> employees, each with a unique id from <code>0</code> to <code>n - 1</code>.</p>
